        ...
        if ($this->configProvider->isModuleEnabled()) {
            ...
            if ($this->configProvider->isAllowed(Config::ANONYMIZE) && $this->isVisible()) {
                $result[self::ANONYMISE_DATA_BLOCK_SHORT_NAME] = [
                    ...
                    'content' => __(
                        'Your personal data will be replaced with non-personal anonymous
                        information. When you get a new login by e-mail, your e-mail address
                        and all other personal data will be removed from the website.'
                    ),
                    'hasCheckbox' => true,
            ...
            if ($this->configProvider->isAllowed(Config::DELETE)) {
                $result[self::DELETE_ACCOUT_BLOCK_SHORT_NAME] = [
                    ...
                    'cssModifier' => '-delete',
                    'content' => __(
                        'All your orders, personal data and other information related
                        to your account or purchases will be lost. You will not be able
                        to restore access to your account after we approve your removal request.'
                    ),
                    'checked' => true,
                    'hasCheckbox' => true,
