...
class Combine extends AbstractCombine
{
    ...
    public function __construct(
        ...
        $this->setType(\Amasty\Groupcat\Model\Rule\Condition\ActionConditions\Combine::class);
    }
    ...
    {
        /** @var \Amasty\Groupcat\Model\Rule\Condition\ActionConditions\Customer $condition */
        $condition = $this->conditionCustomerFactory->create();
        $conditionAttributes = $condition->getNewChildSelectOptions();

        $options = [
            [
                'value' => \Amasty\Groupcat\Model\Rule\Condition\ActionConditions\Combine::class,
