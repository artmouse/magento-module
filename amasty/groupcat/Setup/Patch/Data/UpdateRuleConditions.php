...
class UpdateRuleConditions implements DataPatchInterface
{
    ...
    public function apply()
    {
        ...
        $ruleConditionsClassMap = [
            'Amasty\Groupcat\Model\Rule\Condition\Product\Combine' =>
        ...
        $actionConditionsClassMap = [
            'Amasty\Groupcat\Model\Rule\Condition\Customer\Combine' =>
                Condition\ActionConditions\Combine::class,
            'Amasty\Groupcat\Model\Rule\Condition\Customer' =>
