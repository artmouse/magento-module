...
class CustomerGroupId implements CustomJoinInterface
{
    public function apply(AbstractDb $collection)
    {
        $collection->getSelect()->joinLeft(
            [
                CreateQuestionCustomerGroupTable::TABLE_NAME =>
                    $collection->getTable(CreateQuestionCustomerGroupTable::TABLE_NAME)
            ],
            'main_table.' . QuestionInterface::QUESTION_ID . ' = '
            . CreateQuestionCustomerGroupTable::TABLE_NAME . '.' . QuestionInterface::QUESTION_ID,
            []
        );
